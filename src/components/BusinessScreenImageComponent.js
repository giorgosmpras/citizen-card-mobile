  ...
  const handleImageUpload = async () => {
    try {
      ...
      try {
        ...
        const userId = await AsyncStorage.getItem("@TempBusinessId");
        //setId(JSON.parse(userId));
        //console.log(JSON.parse(userId))
        // Assuming your API endpoint for image upload is "https://your-api-endpoint/upload"
        const apiUrl =
          `${EXPO_PUBLIC_BASE_URL}/api/profile/business/upload?_id=` + userId;
      ...
      toast.show("Επιτυχής αλλαγή εικόνας προφίλ!", {
        type: "normal",
        placement: "bottom",
        duration: 4000,
        offset: 30,
