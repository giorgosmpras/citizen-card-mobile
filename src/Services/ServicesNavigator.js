...
import ServicesListNavigator from "./ServicesListNavigator";
import BussinessListNavigator from "../Business/BussinessListNavigator";
import HomeNavigatorServices from "./HomeNavigatorServices";
...
function AppBottomStack({ navigation }) {
  return (
    ...
    >
      <Tab.Screen
        name="Home"
        component={HomeNavigatorServices}
