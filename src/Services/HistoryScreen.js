...
// SCREEN TO SHOW THE USERS THAT HAVE BEEN SCANNED FROM THE SERVICE
export default function HistoryScreen({ navigation }) {
  ...
  let url = `${EXPO_PUBLIC_BASE_URL}/api/organization/services-data?services_id=`;
  ...
  useEffect(() => {
    ...
    const getData = async () => {
      ...
      setData(json.service.service_activity.reverse());
      console.log(data);
    };
