...
// HOMESCREEN FOR BUSINESS
export default function HomeScreenBussiness({ navigation }) {
  ...
  const handleUpdatePress = () => {
    navigation.navigate("BusinessProfileScreenNavigator");
  };
  const handleChangePhoto = () => {
    navigation.navigate("BusinessProfileAddNewImage");
  };
  ...
  const getBusiness_Id = async () => {
    ...
    setBusiness_Id(json.business._id);
  };
